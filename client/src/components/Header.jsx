      ...
      <div className="relative">
        ...
        <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between w-full px-10 py-4 md:mx-5">
          ...
          <ul className="hidden md:flex">
            <li className="inline-block mx-4 text-white hover:text-teal-400 cursor-pointer">Task List</li>
            <li className="inline-block mx-4 text-white hover:text-teal-400 cursor-pointer">Spin</li>
          </ul>
